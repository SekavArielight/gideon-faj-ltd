    ...
    <div className="bg-aboutBlack pb-28">
      <div className="max-w-screen-2xl mx-auto text-center text-[#fefefe]">
        ...
        <p className="px-28 font-bold">
          ...
          through exceptional branding (consultation, logo, visual identity
          design), digital marketing, web design, and unique printing solutions.
          We are committed to delivering outstanding service that exceeds client
          expectations and drives meaningful results for their businesses.
        </p>
      </div>
    </div>
  );
